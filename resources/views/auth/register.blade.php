        ...
        <div class="row d-flex justify-content-center">
            <div class="col-12 col-md-5">
                <form method="POST" action="{{route('register')}}">
                    @csrf
                    <div class="mb-3 mt-3">
                        <label for="exampleInputEmail1" class="form-label"><h5>Inserisci il tuo nome</h5></label>
                    ...
                    <div class="mb-3">
                        <label for="mypassword" class="form-label"><h5>Inserisci una password</h5></label>
                        <input type="password" class="form-control" name="password">
                    </div>
                    <div class="mb-5">
                        <label for="mypassword2" class="form-label"><h5>Conferma password</h5></label>
                        <input type="password" class="form-control" name="password_confirmation">
                    </div>
                    <div class="mb-4 d-flex justify-content-around">
                        <button type="submit" class="btn mybtn mb-5">Registrati</button>
