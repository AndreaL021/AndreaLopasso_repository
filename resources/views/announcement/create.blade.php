      ...
      <div class="container ">
          <div class="row d-flex justify-content-center text-center align-content-center">
              ...
              <div class="row d-flex justify-content-center text-center">
                  ...
                  <form method="POST" action="{{route('announcement.store')}}" class="mt-5">
                      @csrf
                      <div class="mb-3">
                        <h4>Titolo</h4>
                      ...
                      <div class="mb-3">
                        <h4 for="Select" class="form-label">Categoria annuncio</h4>
                      ...
                      <div class="mb-3">
                        <h4 for="exampleInputEmail1" class="form-label">Inserisci prezzo</h4>
